...
execute as @a[scores={livestock_compass_tp=1}] unless score @s livestock_compass_tp_msg_on matches 1 run function wawo:trigger/livestock_compass_tp_on
execute as @a[scores={livestock_compass_tp=2..}] unless score @s livestock_compass_tp_msg_off matches 1 run function wawo:trigger/livestock_compass_tp_off