...
execute at @s unless score @s goat_horn_tpa matches 1 unless score @s wawo.tpa matches 1 if score $rift_opened wawo.tpa matches 1 run data modify storage wawo:tpa uuid set from entity @s UUID
